...
class Game:
    ...
    def __init__(self, game_model, fps, pixel_size, screen_width, screen_height, navigation_bar_height,
        ...
        self.fruit.points = [self._screen_normalized_point(x) for x in self.environment.set_fruit()]
    ...
    def _sync_screen_with_environment(self):
        self.fruit.points = [self._screen_normalized_point(x) for x in self.environment.fruit]
        self.snake.points = [self._screen_normalized_point(x) for x in self.environment.snake]
